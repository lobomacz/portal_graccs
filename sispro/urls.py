...
#router.register(r'mapa-municipio', GeoMunicipiosViewSet)
router.register(r'mapa-comunidad', GeoComunidadesViewSet)
...
router.register(r'bonos-protagonista', ProtagonistasBonosViewSet, basename='bonos-protagonista')
router.register(r'planes-protagonista', ProtagonistasPlanesViewSet, basename='planes-protagonista')
